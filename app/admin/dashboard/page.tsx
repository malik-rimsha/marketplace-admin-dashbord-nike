...
//     }, []);
//     const filteredOrder = filter === "All" ? order : order.filter((order) => order.status === filter)

//     const toggledOrderDetails = (orderId: string) => {
...
//                 setOrder((prevOrder) => prevOrder.filter((order) => order._id !== orderId));
...
//                 setOrder((prevOrder) => prevOrder.map((order) => order._id === orderId ? {
//                     ...order,
//                     status: newStatus,
//                 }
//                     : order)
